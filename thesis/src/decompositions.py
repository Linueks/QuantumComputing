...
def trotter_step_n_xyz(
    ...
    quantum_circuit = qk.QuantumCircuit(quantum_register)
    quantum_circuit += n_xyz_subcircuit(time, quantum_register, qubit1, qubit2)
    quantum_circuit += n_xyz_subcircuit(time, quantum_register, qubit2, qubit3)
...
def trotter_second_zyxyzzyxyz(
    ...
    qubit1, qubit2, qubit3 = active_qubits
    quantum_circuit = qk.QuantumCircuit(quantum_register)
    quantum_circuit += zz_subcircuit(time/2, quantum_register, qubit1, qubit2)
    quantum_circuit += yy_subcircuit(time/2, quantum_register, qubit1, qubit2)
    quantum_circuit += xx_subcircuit(time, quantum_register, qubit1, qubit2)
    quantum_circuit += yy_subcircuit(time/2, quantum_register, qubit1, qubit2)
    quantum_circuit += zz_subcircuit(time/2, quantum_register, qubit1, qubit2)

    quantum_circuit += zz_subcircuit(time/2, quantum_register, qubit2, qubit3)
    quantum_circuit += yy_subcircuit(time/2, quantum_register, qubit2, qubit3)
    quantum_circuit += xx_subcircuit(time, quantum_register, qubit2, qubit3)
    quantum_circuit += yy_subcircuit(time/2, quantum_register, qubit2, qubit3)
    quantum_circuit += zz_subcircuit(time/2, quantum_register, qubit2, qubit3)
